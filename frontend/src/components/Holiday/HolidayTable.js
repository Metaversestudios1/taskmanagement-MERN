...
const HolidayTable = () => {
    ...
    const handleDelete = async (e, id) => {
        e.preventDefault();
        const holidayofDelete = window.confirm("Are you sure, you want to delete the holiday");
        if (holidayofDelete) {
    ...
    return (<div className="">
        ...
        <div className="relative overflow-x-auto m-5 mb-0">
            {holiday.length > 0 ? <table className="w-full text-sm text-left rtl:text-right border-2 border-gray-300">
        ...
        {holiday.length > 0 && <div className="flex flex-col items-center my-10">
