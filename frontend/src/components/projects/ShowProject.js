          ...
          <div className="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
              <label
                ...
                className="block mb-2 text-sm font-medium text-gray-900 dark:text-black font-bold"
                style={{ fontWeight: 'bold' }}
              >
                Scope Finalization Date : {oldData.scope_finalization_date}
              </label>
          ...
          <div className="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
              <label
                ...
                style={{ fontWeight: 'bold' }}
              >
                 Status :{oldData.status === 0 ? 'Inactive' : oldData.status === 1 ? 'Active':'unknown'}
              </label>
