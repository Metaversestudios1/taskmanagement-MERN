...
const connectDB = async () => {
    try {
         await mongoose.connect("mongodb+srv://socialtridentverse:Taskmanagement@taskmanagement.xs0sq.mongodb.net/?retryWrites=true&w=majority&appName=taskmanagement");
